...
class DepartmentsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ...
            ->maxLength('department_name', 15)
            ->requirePresence('department_name', 'create')
            ->notEmptyString('department_name')
            ->add('department_name', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);
    ...
    {
        $rules->add($rules->isUnique(['department_name']), ['errorField' => 'department_name']);
