...
class DepartmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'department_name' => ['type' => 'string', 'length' => 15, 'default' => null, 'null' => false, 'collate' => null, 'comment' => null, 'precision' => null],
        ...
        '_constraints' => [
            ...
            'uniq_department_name' => ['type' => 'unique', 'columns' => ['department_name'], 'length' => []],
        ],
    ];
    // phpcs:enable
    /**
    ...
    public function init(): void
    {
        $this->records = [
            [
                'id' => '170c5bfd-76d5-4384-94bd-f5aa9580fdbc',
                'department_name' => 'Lorem ipsum d',
                'created' => 1617445388,
                'modified' => 1617445388,
            ],
        ];
